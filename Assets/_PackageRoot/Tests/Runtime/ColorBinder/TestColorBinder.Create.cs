...
namespace Unity.Theme.Tests
{
    public partial class TestColorBinder : TestBase
    {
        ...
        [UnityTest] public IEnumerator Create_Image()
        {
        ...
        [UnityTest] public IEnumerator Create_TextMeshProUGUI()
        {
        ...
        [UnityTest] public IEnumerator Create_SpriteRenderer()
        {
        ...
        [UnityTest] public IEnumerator Create_Shadow()
        {
        ...
        [UnityTest] public IEnumerator Create_Outline()
        {
